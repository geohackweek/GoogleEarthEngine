...
Full module code for later reference can be found in the shared code repository. Instructions to join this folder can be found on the [GEE Access page](https://geohackweek.github.io/GoogleEarthEngine/00-access-javascript/). A static version of the code can be accessed here: [https://code.earthengine.google.com/8dea6acc73e01afc7d3bad8d86fa1994](https://code.earthengine.google.com/8dea6acc73e01afc7d3bad8d86fa1994)*
